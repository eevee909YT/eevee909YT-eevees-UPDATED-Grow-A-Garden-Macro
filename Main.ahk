; eevee's UPDATED Grow A Garden Macro
...
seedItems := ["Carrot Seed", "Strawberry Seed", "Blueberry Seed", "Orange Tulip Seed"
             , "Tomato Seed", "Corn Seed", "Daffodil Seed"
             , "Watermelon Seed", "Pumpkin Seed", "Apple Seed", "Bamboo Seed"
             , "Coconut Seed", "Cactus Seed", "Dragon Fruit Seed", "Mango Seed"
             , "Grape Seed", "Mushroom Seed", "Pepper Seed", "Cacao Seed", "Beanstalk Seed"
             , "Ember Lily Seed", "Sugar Apple Seed", "Burning Bud Seed", "Giant Pinecone Seed", "Elder Strawberry Seed"]
...
;realHoneyItems := ["No Honey Update Anymore"]
...
Gui, Add, Picture, x40 y180 w48 h48, % mainDir "Images\\eevee.png"
Gui, Font, s10 cWhite Bold, Segoe UI
Gui, Add, Text, x100 y180 w200 h24, eevee909_YT
Gui, Font, s8 c87CEEB Italic, Segoe UI
Gui, Add, Text, x100 y206 w200 h16, UPDATED Macro Editor
Gui, Font, s8 cWhite, Segoe UI
Gui, Add, Text, x40 y240 w400 h30, Literally all i did was UPDATE the macro :>
    ...
    Gui, Show, w520 h460, eevee's UPDATED Grow A Garden Macro
